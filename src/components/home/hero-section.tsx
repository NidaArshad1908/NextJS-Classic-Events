...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div className="relative top-25 w-275 h-100 flex items-center justify-center text-center text-gray px-4  rounded-2xl">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="#services">
              <Button className="bg-transparent hover:bg-primary-dark text-black px-8 py-6 rounded-md text-lg font-medium h-auto w-full sm:w-auto">
                Our Services
              </Button>
            </Link>
            <Link href="#contact">
